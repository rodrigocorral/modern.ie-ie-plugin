...
#ifndef __IModernIEConfigButton_FWD_DEFINED__
#define __IModernIEConfigButton_FWD_DEFINED__
typedef interface IModernIEConfigButton IModernIEConfigButton;

#endif 	/* __IModernIEConfigButton_FWD_DEFINED__ */
...
#ifndef __ModernIEConfigButton_FWD_DEFINED__
#define __ModernIEConfigButton_FWD_DEFINED__

#ifdef __cplusplus
typedef class ModernIEConfigButton ModernIEConfigButton;
#else
typedef struct ModernIEConfigButton ModernIEConfigButton;
#endif /* __cplusplus */

#endif 	/* __ModernIEConfigButton_FWD_DEFINED__ */
...
#ifndef __IModernIEConfigButton_INTERFACE_DEFINED__
#define __IModernIEConfigButton_INTERFACE_DEFINED__

/* interface IModernIEConfigButton */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IModernIEConfigButton;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("7F34937D-2446-45E3-921F-5D9004D96584")
    IModernIEConfigButton : public IDispatch
    {
    public:
    };
    ...
    typedef struct IModernIEConfigButtonVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IModernIEConfigButton * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        END_INTERFACE
    } IModernIEConfigButtonVtbl;

    interface IModernIEConfigButton
    {
        CONST_VTBL struct IModernIEConfigButtonVtbl *lpVtbl;
    };
...
#define IModernIEConfigButton_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IModernIEConfigButton_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IModernIEConfigButton_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IModernIEConfigButton_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IModernIEConfigButton_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IModernIEConfigButton_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IModernIEConfigButton_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 
...
#endif 	/* __IModernIEConfigButton_INTERFACE_DEFINED__ */
...
EXTERN_C const CLSID CLSID_ModernIEConfigButton;

#ifdef __cplusplus

class DECLSPEC_UUID("C2388301-15A8-47AA-AF66-A80820458081")
ModernIEConfigButton;
#endif
